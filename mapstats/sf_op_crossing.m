...
function crossing = sf_op_crossing(sf, op, nangles)
%SF_OP_CROSSING Calculate angles of intersection of SF and OP contours.
%
% crossing = sf_op_crossing(sf, op, nangles)
%
% Calculates the angle of intersection of all crossings of the iso-contours of
% the given SF and OD maps. Four log-spaced contours between log10(0.5)
% and log10(2) are used for the SF map, and nangles (default is 4) equally
% spaced iso-orientation contours of the OP map.
%
